...
export default function TopHeader() {
  return (
    <div className={`"w-full flex justify-center items-center py-[8px] bg-secondary ${poppins.className}"`}>
      <div className="w-full flex-1 flex justify-between items-center px-3 text-[14px] text-white">
        <ul className="lg:flex items-center text-white  gap-4 px-6 font-normal hidden">
          <li>
        ...
        <ul className="flex w-full md:w-fit justify-center md:justify-end items-center gap-4 px-4">
          <Link
